            ...
            <table>
                ...
                <tr>
                    <td colspan="3" style="text-align: left; width: 50%;">
                        ...
                        <span style="font-size: smaller;"><b>Nama Barang</b></span> &ensp; Parachute {{ $item->parachute->type ?? '-' }}
                    </td>
                    <td colspan="3" style="text-align: left; width: 50%;">
                ...
                <tr>
                    <td colspan="2" style="text-align: left;">
                        <span style="font-size: smaller;">
                            <b>Part No.</b> &ensp; {{ $item->parachute->part_number ?? '-' }}
                        </span>
                    </td>
                ...
                <tr>
                    <td colspan="2" style="text-align: left;">
                        <span style="font-size: smaller;">
                            <b>Serial No.</b> &ensp; {{ $item->parachute->serial_number ?? '-' }}
                        </span>
                    </td>
                    <td colspan="2" style="text-align: left;">
