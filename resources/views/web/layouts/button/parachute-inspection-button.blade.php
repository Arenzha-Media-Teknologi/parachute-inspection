...
<div class="text-center">
    ...
    @if($isUnserviceable)
    <a href="/parachute-inspection/print-tag/{{ $model->id }}" target="_blank" class="btn btn-sm btn-success hover-scale me-2" style="background-color: #673AB7" data-id="{{ $model->id }}">
