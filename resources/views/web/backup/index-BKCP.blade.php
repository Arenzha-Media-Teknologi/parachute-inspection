            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-12">
                        ...
                        <div class="alert d-flex flex-column flex-sm-row p-5 mb-10" style="background-color:rgb(103, 80, 4) !important;">
                            <i class="ki-duotone ki-shield fs-2hx text-light me-4 mb-5 mb-sm-0"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
                            <div class="d-flex flex-column text-light pe-0 pe-sm-10">
                                <h4 class="mb-2 text-white">Restore Database</h4>
                                ...
                                <form action="{{ route('backup.restore') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="backup_file">Pilih file backup (.zip):</label>
                                        <input type="file" name="backup_file" id="backup_file" class="form-control" accept=".zip" required>
                                    </div>
                                    <button type="submit" class="btn btn-primary mt-2" onclick="return confirm('Apakah Anda yakin ingin me-restore data ini? Semua data saat ini akan ditimpa.')">
                                        Restore Sekarang
                                    </button>
                                </form>
                                <div class="card-body">
